...
class BoardFishBotLaser(Board):
    def __init__(self,logger):
        super().__init__('FishBot 雷达转接板','fishbot_laser',logger=logger)
    ...
    def write_flash(self,device: Device,bin_file=None):
        ...
        self.esp_helper.write_flash(device.device_name,460800,'esp8266',bin_file)
